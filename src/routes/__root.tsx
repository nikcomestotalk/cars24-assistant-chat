...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cars24 AI Assistant" },
      { name: "description", content: "Your AI guide for buying, selling and financing cars on Cars24." },
      { name: "author", content: "Cars24" },
      { property: "og:title", content: "Cars24 AI Assistant" },
